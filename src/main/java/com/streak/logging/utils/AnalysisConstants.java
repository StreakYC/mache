...
public class AnalysisConstants {
	...
	public static final String LOGS_EXPORTER_CONFIGURATION_PARAM = "logsExportConfiguration";
	...
	public static final String TABLE_RANGE_START_MS = "tableRangeStartMs";
	public static final String TABLE_RANGE_END_MS = "tableRangeEndMs";
	public static final String LOG_RANGE_START_MS = "logRangeStartMs";
	public static final String LOG_RANGE_END_MS = "logRangeEndMs";

	public static final String JOB_ID_PARAM = "jobId";
	
	public static int NUM_TASKS_TO_GENERATE_PER_ENQUEUE = 60;
	public static long MILLIS_TO_DELAY_TASKS_BEFORE_RUNNING = 60000;
}
